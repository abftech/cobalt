...
#         for email in emails:
#             logger.debug(f"To: {email.context['name']}   Subject: {email.context['title']}")
#
...
#
#     if debug:
#         logger.debug(f"Finished handle_email_to. There are now {emails.count()} emails.")
#
#
...
#     if email_to:
#
#         ok, output, emails = _check_email_sent_tests_handle_email_to(output, email_to, emails, debug)
#
#         if not ok:
#             output += "Failed on email_to."
#             if debug:
#                 logger.debug("Email Check: Failed to match any emails in email_to check")
#             return ok, output
#
#
#     if subject_search:
#
#         ok, output, emails = _check_email_sent_tests_handle_subject(output, subject_search, debug, emails)
#
#         if not ok:
#             output += "Failed on subject_search."
#             if debug:
#                 logger.debug("Email Check: Failed to match any emails in subject_search check")
#             return ok, output
#
#     if body_search:
#
#         ok, output, emails = _check_email_sent_tests_handle_body(output, body_search, debug, emails)
#
#         if not ok:
#             output += "Failed on body_search."
#             if debug:
#                 logger.debug("Email Check: Failed to match any emails in body_search check")
#             return ok, output
#
...
#         return
#
#     logger.debug(f"debug: {check}: looked for '{search_str}'. Match: id: {email.id} to: {email.context['name']} subject: {email.context['subject']}")
