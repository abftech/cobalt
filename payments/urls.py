...
import payments.views.admin
import payments.views.players
import payments.views.orgs
from .views import core

app_name = "payments"  # pylint: disable=invalid-name

urlpatterns = [
    path("", payments.views.players.statement, name="payments"),
    ...
    path(
        "manual-adjust-org",
        payments.views.admin.manual_adjust_org,
    ...
    path(
        ...
        payments.views.admin.statement_admin_view,
        name="statement_admin_view",
    ),
    path(
        "statement-csv",
        payments.views.players.statement_csv,
        name="statement_csv",
    ),
    path(
    ...
    path(
        "statement-pdf",
        payments.views.players.statement_pdf,
        name="statement_pdf",
    ),
    path(
        "setup-autotopup",
        payments.views.players.setup_autotopup,
        name="setup_autotopup",
    ),
    path(
        "update-auto-amount",
        payments.views.players.update_auto_amount,
        name="update_auto_amount",
    ),
    path(
        "admin-orgs-with-balance",
        payments.views.admin.admin_orgs_with_balance,
        name="admin_orgs_with_balance",
    ),
    path(
        "admin-members-with-balance",
        payments.views.admin.admin_members_with_balance,
        name="admin_members_with_balance",
    ),
    path(
        "admin-members-with-balance-csv",
        payments.views.admin.admin_members_with_balance_csv,
        name="admin_members_with_balance_csv",
    ),
    path(
        "admin-orgs-with-balance-csv",
        payments.views.admin.admin_orgs_with_balance_csv,
        name="admin_orgs_with_balance_csv",
    ),
    path(
        "admin-view-specific-transactions/<str:trans_type>",
        payments.views.admin.admin_view_specific_transactions,
        name="admin_view_specific_transactions",
    ),
    path(
        "member-transfer",
        payments.views.players.member_transfer,
        name="member_transfer",
    ),
    path(
        "manual-topup",
        payments.views.players.manual_topup,
        name="manual_topup",
    ),
    path(
        "cancel-autotopup",
        payments.views.players.cancel_auto_top_up,
        name="cancel_autotopup",
    ),
    path(
        "statement-admin-summary",
        payments.views.admin.statement_admin_summary,
    ...
    path(
        ...
        payments.views.players.pay_user_pending_payment,
